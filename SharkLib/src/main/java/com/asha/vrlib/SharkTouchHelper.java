 ...
 */
public class SharkTouchHelper {

    private SharkLibrary.IAdvanceGestureListener mAdvanceGestureListener;
    private List<SharkLibrary.IGestureListener> mClickListeners = new LinkedList<>();
    ...
    public SharkTouchHelper(Context context) {
        mGestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {

            public boolean onSingleTapConfirmed(MotionEvent e) {
                if (mCurrentMode == MODE_PINCH) return false;

                for (SharkLibrary.IGestureListener listener : mClickListeners){
                    listener.onClick(e);
                }
                return true;
            }
    ...
    public void addClickListener(SharkLibrary.IGestureListener gestureListener) {
        if (gestureListener != null) mClickListeners.add(gestureListener);
    }

    public void setAdvanceGestureListener(SharkLibrary.IAdvanceGestureListener listener) {
    ...
    public void setPinchConfig(SharkPinchConfig pinchConfig) {
