...
public class SharkUtil {
    ...
    public static SharkVector3D vec3Sub(SharkVector3D v1, SharkVector3D v2) {
        return new SharkVector3D().setX(v1.getX() - v2.getX()).setY(v1.getY() - v2.getY()).setZ(v1.getZ() - v2.getZ());
    }


    public static SharkVector3D vec3Cross(SharkVector3D v1, SharkVector3D v2) {
        return new SharkVector3D().setX(v1.getY() * v2.getZ() - v2.getY() * v1.getZ())
                .setY(v1.getZ() * v2.getX() - v2.getZ() * v1.getX())
                .setZ(v1.getX() * v2.getY() - v2.getX() * v1.getY());
    }


    public static float vec3Dot(SharkVector3D v1, SharkVector3D v2) {
        return v1.getX() * v2.getX() + v1.getY() * v2.getY() + v1.getZ() * v2.getZ();
    }


    public static SharkRay point2Ray(float x, float y, SharkDirector director) {
        ...
        if (success) {
            SharkVector3D vPickRayDir = new SharkVector3D();
            SharkVector3D vPickRayOrig = new SharkVector3D();
            ...
            return new SharkRay(vPickRayOrig, vPickRayDir);
        } else {
            return null;
        }
    }
    ...
    public static boolean intersectTriangle(SharkRay ray, SharkVector3D v0, SharkVector3D v1, SharkVector3D v2) {
        // Find vectors for two edges sharing vert0
        SharkVector3D edge1 = vec3Sub(v1, v0);
        SharkVector3D edge2 = vec3Sub(v2, v0);
