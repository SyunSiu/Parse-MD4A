 ...
 */
public class SharkDirector {

    private static final String TAG = "SharkDirector";
    ...
    private final SharkPosition mCameraRotation;
    ...
    protected SharkDirector(Builder builder) {
    ...
    public void shot(SharkProgram program) {
        shot(program, SharkPosition.sOriginalPosition);
    }

    public void shot(SharkProgram program, SharkPosition modelPosition) {
    ...
    public static class Builder {
        ...
        private float mLookX = 0f;
        private float mLookY = 0f;
        private SharkPosition mRotation = SharkPosition.newInstance();
        ...
        public SharkDirector build(){
            return new SharkDirector(this);
        }
    }
}
