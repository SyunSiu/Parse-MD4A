 ...
 */
public class SharkDome3D extends SharkAbsObject3D {
    ...
    public SharkDome3D(RectF textureSize, float degree, boolean isUpper) {
    ...
    @Override
    public void uploadTexCoordinateBufferIfNeed(SharkProgram program, int index) {
    ...
    private static void generateDome(float degree, boolean isUpper, SharkDome3D object3D) {
        generateDome(18, 150, degree, isUpper, object3D);
    }

    public static void generateDome(float radius, int sectors, float degreeY, boolean isUpper, SharkDome3D object3D) {
