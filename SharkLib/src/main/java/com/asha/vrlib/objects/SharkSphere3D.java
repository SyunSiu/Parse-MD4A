 ...
 */
public class SharkSphere3D extends SharkAbsObject3D {

    private static final String TAG = "SharkSphere3D";
    ...
    private static void generateSphere(SharkAbsObject3D object3D) {
     ...
     * */
    private static void generateSphere(float radius, int rings, int sectors, SharkAbsObject3D object3D) {
