 ...
 */
public class SharkPlane extends SharkAbsObject3D {

    private static final String TAG = "SharkPlane";
    ...
    private SharkPlane(PlaneProjection.PlaneScaleCalculator calculator, RectF size) {
        this.mCalculator = calculator;
        this.mSize = size;
    }

    public SharkPlane(PlaneProjection.PlaneScaleCalculator calculator) {
        this(calculator,new RectF(0,0,1.0f,1.0f));
    }

    public SharkPlane(RectF size) {
        this(new PlaneProjection.PlaneScaleCalculator(SharkLibrary.PROJECTION_MODE_PLANE_FULL,new RectF(0,0,100,100)),size);
    }
    ...
    @Override
    public void uploadVerticesBufferIfNeed(SharkProgram program, int index) {
