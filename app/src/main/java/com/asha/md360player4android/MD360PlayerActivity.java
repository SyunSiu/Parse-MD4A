...
public abstract class MD360PlayerActivity extends Activity {
    ...
    static {
        sDisplayMode.put(FishLibrary.DISPLAY_MODE_NORMAL, "NORMAL");
        sDisplayMode.put(FishLibrary.DISPLAY_MODE_GLASS, "GLASS");

        sInteractiveMode.put(FishLibrary.INTERACTIVE_MODE_MOTION, "MOTION");
        sInteractiveMode.put(FishLibrary.INTERACTIVE_MODE_TOUCH, "TOUCH");
        sInteractiveMode.put(FishLibrary.INTERACTIVE_MODE_MOTION_WITH_TOUCH, "M & T");

        sProjectionMode.put(FishLibrary.PROJECTION_MODE_SPHERE, "SPHERE");
        sProjectionMode.put(FishLibrary.PROJECTION_MODE_DOME180, "DOME 180");
        sProjectionMode.put(FishLibrary.PROJECTION_MODE_DOME230, "DOME 230");
        sProjectionMode.put(FishLibrary.PROJECTION_MODE_DOME180_UPPER, "DOME 180 UPPER");
        sProjectionMode.put(FishLibrary.PROJECTION_MODE_DOME230_UPPER, "DOME 230 UPPER");
        sProjectionMode.put(FishLibrary.PROJECTION_MODE_STEREO_SPHERE_HORIZONTAL, "STEREO H SPHERE");
        sProjectionMode.put(FishLibrary.PROJECTION_MODE_STEREO_SPHERE_VERTICAL, "STEREO V SPHERE");
        sProjectionMode.put(FishLibrary.PROJECTION_MODE_PLANE_FIT, "PLANE FIT");
        sProjectionMode.put(FishLibrary.PROJECTION_MODE_PLANE_CROP, "PLANE CROP");
        sProjectionMode.put(FishLibrary.PROJECTION_MODE_PLANE_FULL, "PLANE FULL");
        sProjectionMode.put(FishLibrary.PROJECTION_MODE_MULTI_FISH_EYE_HORIZONTAL, "MULTI FISH EYE HORIZONTAL");
        sProjectionMode.put(FishLibrary.PROJECTION_MODE_MULTI_FISH_EYE_VERTICAL, "MULTI FISH EYE VERTICAL");
    ...
    private FishLibrary mVRLibrary;
...
//        setContentView(R.layout.activity_md_using_surface_view);
        ...
        findViewById(R.id.button_add_plugin).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MDHotspotBuilder builder = MDHotspotBuilder.create()
                        ...
                        .listenClick(new FishLibrary.ITouchPickListener() {
                            @Override
        ...
        findViewById(R.id.button_add_plugin_logo).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MDHotspotBuilder builder = MDHotspotBuilder.create()
                        .size(4f, 4f)
                        .provider(new FishLibrary.IBitmapProvider() {
                            @Override
        ...
        getVRLibrary().setEyePickChangedListener(new FishLibrary.IEyePickListener() {
            @Override
    ...
    abstract protected FishLibrary createVRLibrary();

    public FishLibrary getVRLibrary() {
        return mVRLibrary;
    }
     ...
     * 内部类
     */
    private class AndroidDrawableProvider implements FishLibrary.IBitmapProvider {
