 ...
 */
public class SharkVideoTexture extends SharkTexture {

    private Surface mSurface;
    private SurfaceTexture mSurfaceTexture;
    private SharkLibrary.IOnSurfaceReadyCallback mOnSurfaceReadyListener;

    public SharkVideoTexture(SharkLibrary.IOnSurfaceReadyCallback onSurfaceReadyListener) {
