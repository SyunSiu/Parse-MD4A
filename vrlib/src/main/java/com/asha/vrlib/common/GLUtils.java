 ...
 * GL 矩阵运算 链接program 编译shader等工具类
 */
public class GLUtils {
    ...
    public static void loadObject3D(final Context context, final int resourceId, final SharkAbsObject3D output) {
        ...
        // Vertex
        FloatBuffer vertex = ByteBuffer
                .allocateDirect(vertexBuffer.length * 4)
        ...
        // Texture Coordinate
        FloatBuffer texture = ByteBuffer
                .allocateDirect(textureBuffer.length * 4)
                .order(ByteOrder.nativeOrder())
                .asFloatBuffer()
                .put(textureBuffer);
