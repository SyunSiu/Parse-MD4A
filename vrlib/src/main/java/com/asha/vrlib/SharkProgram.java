...
import static com.asha.vrlib.common.GLUtils.compileShader;
import static com.asha.vrlib.common.GLUtils.createAndLinkProgram;
import static com.asha.vrlib.common.GLUtils.readTextFileFromRaw;

/**
 * Created by hzqiujiadi on 16/1/22.
 * hzqiujiadi ashqalcn@gmail.com
 */
public class SharkProgram {
    ...
    private static class FragmentShaderFactory{
        ...
        static String fs(Context context, int type){
            int resId;
            switch (type){
                case SharkLibrary.ContentType.BITMAP:
                    resId = R.raw.fragment_shader_bitmap;
                    break;
                case SharkLibrary.ContentType.VIDEO:
                default:
